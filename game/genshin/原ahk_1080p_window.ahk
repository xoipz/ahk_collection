...
class Loc{
    ...
    static Option = {x:1302,y:848} ;第一个选项的位置
    static Pick1 = {x:1130,y:590} ;选择框出现时会出现的两个白点（分别对应只有1个和多个选择）
    static Pick2 = {x:1073,y:567} ;多个选择会出现鼠标
    static Trans = {x:1478,y:1047} ;点击传送：0xFFCC33
}
